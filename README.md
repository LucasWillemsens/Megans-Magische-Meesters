...
- [~] Capture and display what the enemy bot did during their turn. _(Capture and display what the enemy bot did during their turn.)_
- [~] Show a brief "enemy is thinking" overlay when the player ends their turn, before the board reloads. _(Show a brief "enemy is thinking" overlay when the player ends their turn, before the board reloads.)_
- [~] Add a turn phase indicator in the board header showing whose turn it is. _(Add a turn phase indicator in the board header showing whose turn it is.)_
...
- [~] # Lane Card Stacking _(# Lane Card Stacking)_
- [~] Highlight the affected lanes when special moves execute so players can instantly see the result of the action. _(Highlight the affected lanes when special moves execute so players can instantly see the result of the action.)_
...
- [~] Add artwork, name, and description support to the game page to make matches easier to identify. _(Add artwork, name, and description support to the game page to make matches easier to identify.)_
...
- [~] Move completed games and challenges into a dedicated history page for better post-game navigation. _(Move completed games and challenges into a dedicated history page for better post-game navigation.)_
